    ...
    <div>
      ...
      <section id="Services" className="EducationServices">
        <ul className="Education_container">
          <li className="Education_flItem">
            {" "}
            <h3>{content.UniPaket}</h3>
            <ul className="University_container">
              <li>
                {" "}
                <p className="University_item">
                  <strong>Past</strong> {content.istenilen}{" "}
                  <strong>{content.bir}</strong> {content.uniyeqebul}
                </p>
              </li>
              <li>
                {" "}
                <p className="University_item">
                  <strong>Present</strong> {content.istenilen}{" "}
                  <strong>{content.iki}</strong> {content.uniyeqebul}{" "}
                </p>
              </li>
              <li>
                <p className="University_item">
                  <strong>Future </strong> {content.istenilen}{" "}
                  <strong>{content.uc}</strong> {content.uniyeqebul}
                </p>
              </li>
            </ul>
          </li>
          <li className="Education_flItem">
            {" "}
            <h3>{content.Onfutureozel}</h3>
            <ul className="University_container">
              <li>
                {" "}
                <p className="University_item">
                  <strong>Past </strong> {content.Polsadayerl}
                </p>
              </li>
              <li>
                {" "}
                <p className="University_item">
                  <strong>Present</strong> {content.Polsadayerl1}
                </p>
              </li>
            </ul>
          </li>
          <li className="Education_flItem flitem1">
            {" "}
            <h3>{content.Vizadestek}</h3>
            <ul className="University_container cont1">
              <li>
                {" "}
                <p className="University_item">{content.Vizayamuraciet}</p>
              </li>
              <li>
                {" "}
                <p className="University_item">{content.Vizayayer} </p>
              </li>
              <li>
                <p className="University_item">{content.Biletbronu}</p>
              </li>
              <li>
                <p className="University_item">{content.Yasayisyeri}</p>
              </li>
              <li>
                <p className="University_item">{content.Birillik}</p>
              </li>
            </ul>
          </li>
        </ul>
      ...
      <section id="Karyera" className="VideoServices">
        <div className="video-wrapper">
          ...
          <div className="Video_items">
            <iframe
              width="560"
              src="https://www.youtube.com/embed/-tjSei5ufc0"
